...
import { Home, BarChart2, LayoutGrid, Calendar, CreditCard, Settings, Menu } from "lucide-react";
...
export default function Sidebar() {
  ...
  return (
    <aside
      className="fixed top-0 left-0 h-full z-40 flex flex-col items-center bg-white border-r border-border-light shadow w-16"
    >
      <button
